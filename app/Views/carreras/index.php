...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h3">Carreras</h1>
    <a href="<?= base_url('carreras/create') ?>" class="btn btn-primary">Crear carrera</a>
</div>
...
<div class="table-responsive">
    <table id="carreras_table" class="table table-striped table-bordered align-middle text-center">
        ...
        <tbody>
            <?php foreach ($carreras as $carrera): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('carreras/edit/' . $carrera['codigo_carrera']) ?>" class="btn btn-sm btn-secondary" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="auto" data-bs-trigger="hover focus" data-bs-content="Editar carrera">
