...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?= base_url('materias/create') ?>" class="btn btn-primary">Crear materia</a>
</div>
...
<div class="table-responsive">
    <table id="materias_table" class="table table-striped table-bordered align-middle text-center">
        ...
        <tbody>
            <?php foreach ($materias as $materia): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url('materias/edit/' . $materia['id_materia']) ?>" class="btn btn-sm btn-secondary" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="auto" data-bs-trigger="hover focus" data-bs-content="Editar materia">
